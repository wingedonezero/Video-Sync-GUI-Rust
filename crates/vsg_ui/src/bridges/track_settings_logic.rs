...
impl ffi::TrackSettingsLogic {
    ...
    /// Get language codes — 1:1 port of `LANGUAGE_CODES` from Python.
    fn get_languages(self: Pin<&mut Self>) -> QString {
        let langs = serde_json::json!([
            {"display": "Undetermined", "code": "und"},
            {"display": "English", "code": "eng"},
            {"display": "Japanese", "code": "jpn"},
            {"display": "Chinese", "code": "chi"},
            {"display": "Korean", "code": "kor"},
            {"display": "French", "code": "fre"},
            {"display": "German", "code": "ger"},
            {"display": "Spanish", "code": "spa"},
            {"display": "Italian", "code": "ita"},
            {"display": "Portuguese", "code": "por"},
            {"display": "Russian", "code": "rus"},
            {"display": "Arabic", "code": "ara"},
            {"display": "Hindi", "code": "hin"},
            {"display": "Thai", "code": "tha"},
            {"display": "Vietnamese", "code": "vie"},
            {"display": "Indonesian", "code": "ind"},
            {"display": "Malay", "code": "may"},
            {"display": "Dutch", "code": "dut"},
            {"display": "Polish", "code": "pol"},
            {"display": "Turkish", "code": "tur"},
            {"display": "Swedish", "code": "swe"},
            {"display": "Norwegian", "code": "nor"},
            {"display": "Danish", "code": "dan"},
            {"display": "Finnish", "code": "fin"},
            {"display": "Greek", "code": "gre"},
            {"display": "Hebrew", "code": "heb"},
            {"display": "Czech", "code": "cze"},
            {"display": "Hungarian", "code": "hun"},
            {"display": "Romanian", "code": "rum"},
            {"display": "Bulgarian", "code": "bul"},
            {"display": "Croatian", "code": "hrv"},
            {"display": "Serbian", "code": "srp"},
            {"display": "Ukrainian", "code": "ukr"},
        ]);
